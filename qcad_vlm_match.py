...
# Fallback chain: cloud -> gemma4:e4b -> gemma4:e2b -> error
DEFAULT_FALLBACK_CHAIN: List[str] = ["kimi-k2.6:cloud", "gemma4:e4b", "gemma4:e2b"]
...
def main():
    ...
    parser.add_argument(
        "--vision-model",
        default="gemma4:e4b",
        help="Preferred VLM model name (default: gemma4:e4b)",
    )
    parser.add_argument(
        "--fallback-chain",
